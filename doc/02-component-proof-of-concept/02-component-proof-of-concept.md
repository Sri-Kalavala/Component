...
My favorite design is one that I called "secure" (the name can be debated). I really wanted 
to do something related to cybersecurity because that's my minor. I haven't started any
of my minor classes yet and this seems like a simple enough project that would help 
me understand some concepts in the future.
...
- Designed a proof of concept for Secure component
